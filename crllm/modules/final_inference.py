...
Based on this reasoning process, here's my answer:"""
    ...
    def generate_answer(
        ...
        **kwargs
        ...
        template = self.templates.get(strategy.value, self.templates['direct_synthesis'])
    ...
    def _format_knowledge_context(self, retrieved_knowledge: Optional[List[Any]]) -> str:
