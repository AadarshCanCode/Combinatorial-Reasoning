        ...
        **kwargs
        ...
        for i, step in enumerate(reasoning_steps):
            ...
            if i in duplicate_groups:
                ...
                similar_indices = [j for j, cluster in duplicate_groups.items() if cluster == cluster_id and j != i]
...
class SemanticFilter:
    ...
    def get_filtering_stats(
        ...
        return {
            ...
            'retention_rate': len(filtered_steps) / len(original_steps) if original_steps else 0,
